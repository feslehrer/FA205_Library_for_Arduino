...
//**** Schalter ********************************************************
#define LCD_LEN 16              // Display-Zeilenl�nge 20 oder 16 (default)
#define LCD_I2C                 // Aktiviert das I2C-Interface
#define LCD_WAIT 10              // Bei Timing-Problemen LCD_WAIT vergr��ern!!
//**********************************************************************
...
#elif (LCD_LEN == 20) 
 #define ZEILE3     0x14        // F�r 20 Zeichen LCDs Zeile3 = 0x14
...
#else   // F�r I2C-Display mit PCF8574T (D7..D4 => P7..P4)!!!
 #define RS       0
 #define RW       1
 #define EN       2
 #define BL       3   //Backlight
 //***** I2C-Adressen und Kontrollbyte f�r den PCF8574 ****************
...
// Ausgabe von 00..99  z.B. f�r Datum, Uhrzeit
