...
// Globale Variablen als �bergabe-Parameter f�r das Datenlogger-Programm (main)
volatile uint8_t jahr,monat,tag,stunde,minute,sekunde;
volatile int16_t temperatur;
volatile uint16_t aktueller_Datensatz;			// -> im gew�hlten EEPROM

// i2c-Adressen f�r Temperatursensor
#define  LM75_ADDR_R  0x91
#define  LM75_ADDR_W  0x90

#define _REC_SIZE_		8				    // Bytes je Datensatz
#define RECORD_MSB  0x08					// Speicheradressen f�r aktuellen Datensatz 
#define RECORD_LSB  0x09					// wird im RTC-Ram batteriegepuffert
#define SAMPLETIME_MSB  0x0A			// Speicheradressen f�r Sample-Time
#define SAMPLETIME_LSB  0x0B			// wird im RTC-Ram batteriegepuffert
#define MAX_RECORD  4095          // Maximale Anzahl an Datens�tzen je EEPROM
                                  // 24LC256: 32kByte / _REC_SIZE_ - 1 = 4095

//**** Datenlogger-Funktionen
void     eeprom_speichertest  (void);
// Eingabe der aktuellen rtc-Zeit �ber ein Eingabeprompt
...
// Gibt den angegebenen Datensatz �ber die serielle Schnittstelle aus
...
// Gibt alle gespeicherten Datens�tze �ber RS232 aus
...
// Gibt den Temperaturwert �ber RS232 aus. 
